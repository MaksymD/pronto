            ...
            <CardContent>
              {editing ? (
                  <div className="space-y-3">
                    ...
                    <div>
                      <label className="text-xs font-medium text-gray-500">{t('fields.instagram')}</label>
                      <input
                          type="text"
                    ...
                    <div>
                      <label className="text-xs font-medium text-gray-500">{t('fields.language')}</label>
                      <select
                  ...
                  <div className="space-y-3 text-sm">
                    ...
                    {client.instagram && (
                        <div className="flex gap-2">
                          <span className="text-gray-400 w-16 shrink-0">{t('fields.instagram')}</span>
                          <a href={`https://instagram.com/${client.instagram.replace(/^@/, '')}`} target="_blank" rel="noopener noreferrer" className="text-pink-600 hover:underline">
                            {client.instagram}
                          </a>
                        </div>
                    )}
